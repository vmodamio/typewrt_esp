...
static const uint16_t splash_subtitle_spans[][3] = {
    {110, 163, 2}, {110, 169, 2}, {110, 187, 3}, {110, 204, 5},
    {110, 223, 2}, {110, 236, 5}, {110, 252, 5}, {110, 261, 2},
    {111, 163, 3}, {111, 168, 3}, {111, 188, 2}, {111, 203, 2},
    {111, 208, 2}, {111, 222, 2}, {111, 235, 2}, {111, 240, 2},
    {111, 251, 2}, {111, 256, 2}, {111, 262, 2}, {112, 163, 8},
    {112, 188, 2}, {112, 208, 2}, {112, 221, 2}, {112, 240, 2},
    {112, 251, 2}, {112, 256, 2}, {112, 263, 2}, {113, 163, 8},
    {113, 172, 4}, {113, 179, 2}, {113, 182, 3}, {113, 188, 2},
    {113, 192, 2}, {113, 207, 2}, {113, 221, 2}, {113, 227, 2},
    {113, 233, 2}, {113, 239, 2}, {113, 251, 2}, {113, 256, 2},
    {113, 263, 2}, {114, 163, 2}, {114, 166, 2}, {114, 169, 2},
    {114, 175, 2}, {114, 180, 3}, {114, 184, 2}, {114, 188, 2},
    {114, 191, 2}, {114, 206, 2}, {114, 221, 2}, {114, 227, 2},
    {114, 233, 2}, {114, 238, 2}, {114, 251, 2}, {114, 254, 1},
    {114, 256, 2}, {114, 263, 2}, {115, 163, 2}, {115, 169, 2},
    {115, 172, 5}, {115, 180, 2}, {115, 184, 2}, {115, 188, 4},
    {115, 205, 2}, {115, 221, 2}, {115, 227, 2}, {115, 233, 2},
    {115, 237, 2}, {115, 251, 2}, {115, 254, 1}, {115, 256, 2},
    {115, 263, 2}, {116, 163, 2}, {116, 169, 4}, {116, 175, 2},
    {116, 180, 2}, {116, 188, 4}, {116, 204, 2}, {116, 221, 2},
    {116, 227, 2}, {116, 233, 2}, {116, 236, 2}, {116, 251, 2},
    {116, 256, 2}, {116, 263, 2}, {117, 163, 2}, {117, 169, 4},
    {117, 175, 2}, {117, 180, 2}, {117, 188, 2}, {117, 191, 2},
    {117, 203, 2}, {117, 221, 2}, {117, 228, 2}, {117, 232, 2},
    {117, 235, 2}, {117, 251, 2}, {117, 256, 2}, {117, 263, 2},
    {118, 163, 2}, {118, 169, 4}, {118, 175, 2}, {118, 180, 2},
    {118, 188, 2}, {118, 192, 2}, {118, 203, 2}, {118, 208, 2},
    {118, 222, 2}, {118, 229, 4}, {118, 235, 2}, {118, 240, 2},
    {118, 246, 2}, {118, 251, 2}, {118, 256, 2}, {118, 262, 2},
    {119, 163, 2}, {119, 169, 2}, {119, 172, 3}, {119, 176, 2},
    {119, 179, 4}, {119, 187, 3}, {119, 192, 2}, {119, 203, 7},
    {119, 223, 2}, {119, 230, 2}, {119, 235, 7}, {119, 246, 2},
    {119, 252, 5}, {119, 261, 2},
};
static void splash_prepare(NextviEditor *ed)
{
    ...
    for (int i = 0; i < (int)(sizeof(splash_subtitle_spans) / sizeof(splash_subtitle_spans[0])); i++) {
        int y = splash_subtitle_spans[i][0];
        int x = splash_subtitle_spans[i][1];
        int len = splash_subtitle_spans[i][2];
        for (int dx = 0; dx < len; dx++) {
            splash_set_pixel(ed, x + dx, y, true);
        }
    }
